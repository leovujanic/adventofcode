...
use leovujanic\adventofcode\SecondDay;

/**
 * Class SecondDayTest
 */
class SecondDayTest extends \Codeception\Test\Unit
{
    /**
     * @var \UnitTester
     */
    ...
    private $testString = '116	1259	1045	679	1334	157	277	1217	218	641	1089	136	247	1195	239	834
    ...
    {
        $this->day = new SecondDay();
    }
    
    
    public function testFirstSolution()
    {
        $actual = $this->day->first($this->testString);
        
        $this->tester->assertEquals(41887, $actual);
    }
    
    
    public function testSecondSolution()
    {
        $actual = $this->day->second($this->testString);
        
        $this->tester->assertEquals(226, $actual);
    }
}
