 ...
 * Apparently, you only get one millisecond to solve the captcha: too fast for a normal human, but it feels like hours
 * to you.
 *
...
class FirstDay
{
     ...
     * @return int
     */
    public function second(string $digits): int
    {
        $digits = str_split($digits);
